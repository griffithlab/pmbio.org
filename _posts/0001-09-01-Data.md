...
We will be using data from a well-described breast cancer cell line (HCC1395) and its match lymphoblastoid cell line for subsequent analyses. The data are hosted on our server at: http://genomedata.org/pmbio-workshop/fastqs/ 
