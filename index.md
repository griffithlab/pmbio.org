...
{% include figure.html image="/assets/WorkflowOverview.png" position="right" width="600" %}
...
{% include figure.html image="/assets/prinfo-logo.png" position="left" width="225" author="Katie Campbell" %}
